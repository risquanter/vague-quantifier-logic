...
/** FOL → typed predicate bridge.
  ...
  * architecture described in EVALUATION-PATH-UNIFICATION.md (Decision D2):
  * 
  *   String query → Parser → VagueQuery(FOL) → FOLBridge.scopeToPredicate → VagueQuery[RelationValue]
  * 
