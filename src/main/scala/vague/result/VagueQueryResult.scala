...
/** Unified result type for all vague quantifier evaluations.
  ...
  * - `vague.semantics.QueryResult` (flat 5-field, no CI)
  * - `vague.query.QueryResult` (wrapper around QuantifierResult)
  * - `vague.quantifier.QuantifierResult` (inner result type)
  * 
  ...
  * 
  * See docs/EVALUATION-PATH-UNIFICATION.md, Decision D3.
  * 
